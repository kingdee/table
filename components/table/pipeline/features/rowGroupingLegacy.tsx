...
/** @deprecated 请使用新版 rowGrouping 代替 */
export interface RowGroupingLegacyFeatureOptions {
  /** 非受控用法：是否默认展开所有分组 */
...
/** @deprecated 请使用新版 rowGrouping 代替 */
export function rowGroupingLegacy (opts: RowGroupingLegacyFeatureOptions = {}) {
  return (pipeline: TablePipeline) => {
    ...
    const onChangeOpenKeys: RowGroupingLegacyFeatureOptions['onChangeOpenKeys'] = (nextKeys, key, action) => {
